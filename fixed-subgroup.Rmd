...
## Original scenario vs 
## 3 IPD + 1 agg IPD + 5 agd vs 
...
coe.forest.fig <- function(filter_1, x1, y1, x2, ypot, dt=coeff.mod.f) {
...
mutate("Mean (95% CI)" = paste0("(", lower, ", ", upper, ")")) %>%
...
p2
## psa and interaction
p3 <- coe.forest.fig("psa", -2, 1.5, -1.5, 0.4, coeff.mod.f.2)
p3
## prevsys and interaction
